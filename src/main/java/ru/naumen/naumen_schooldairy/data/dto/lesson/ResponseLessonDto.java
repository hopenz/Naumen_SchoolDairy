 ...
 * @param responseMarkWithSubjectDto набор объектов ResponseMarkDto, представляющих оценки, связанные с занятием.
 ...
 */
public record ResponseLessonDto(Long id, Set<ResponseMarkWithSubjectDto> responseMarkWithSubjectDto,
